...
entry mk_ba_precolored_test (num_cams:i64) (num_points:i64) (num_obs:i64)
  : (i64, i64, i64,
     [3*num_obs+1]i64, []i64,
...
-- ==
-- entry: bench_sparse_jvp_to_csr_ba_d2_precolored
-- script input { mk_ba_precolored_test 32 128 2048 }
-- script input { mk_ba_precolored_test 64 256 8192 }
-- script input { mk_ba_precolored_test 80 320 12288 }
-- script input { mk_ba_precolored_test 96 384 16384 }
entry bench_sparse_jvp_to_csr_ba_d2_precolored
