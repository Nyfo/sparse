...
def rand_vec [n] (seed:i64) : [n]f64 =
  -- hash function (based on MurmurHash3), reused from earlier DPP group project: https://github.com/armadi1809/vtree/blob/main/benchmarks/benchmark_operations.fut
  let hash (x: u64) : u64 =
    let x = x ^ (x >> 30)
