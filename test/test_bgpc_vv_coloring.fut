...
-- ==
-- entry: test_bgpc_vv_cols_ex1_exact
-- input  { }
-- output { true }
entry test_bgpc_vv_cols_ex1_exact : bool =
...
-- ==
-- entry: test_bgpc_vv_cols_empty_pattern
-- input  { }
-- output { true }
entry test_bgpc_vv_cols_empty_pattern : bool =
  let ((row_offs, row_idx), (col_offs, col_idx)) =
...
-- ==
-- entry: test_bgpc_vv_cols_diagonal_pattern
-- input  { }
-- output { true }
entry test_bgpc_vv_cols_diagonal_pattern : bool =
  let ((row_offs, row_idx), (col_offs, col_idx)) =
...
-- ==
-- entry: test_bgpc_vv_cols_dense_pattern
-- input  { }
-- output { true }
entry test_bgpc_vv_cols_dense_pattern : bool =
  let ((row_offs, row_idx), (col_offs, col_idx)) =
...
-- ==
-- entry: test_bgpc_vv_cols_star_pattern
-- input  { }
-- output { true }
entry test_bgpc_vv_cols_star_pattern : bool =
  let ((row_offs, row_idx), (col_offs, col_idx)) =
...
-- ==
-- entry: test_bgpc_vv_rows_ex1_valid
-- input  { }
-- output { true }
entry test_bgpc_vv_rows_ex1_valid : bool =
  let ((row_offs, row_idx), (col_offs, col_idx)) =
    CSR.csr_bipartite_from_pattern pat_ex1
  let colors =
...
-- ==
-- entry: test_bgpc_vv_rows_dense_pattern
-- input  { }
-- output { true }
entry test_bgpc_vv_rows_dense_pattern : bool =
  let ((row_offs, row_idx), (col_offs, col_idx)) =
    CSR.csr_bipartite_from_pattern pat_dense
  let colors =
    Col.vv_color_rows row_offs row_idx col_offs col_idx
